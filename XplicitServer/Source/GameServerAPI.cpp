...
void XplicitLoadServerLua() noexcept
{
	...
	Xplicit::Lua::XLuaStateManager::get_singleton_ptr()->run_string("_G.Humanoid.Set = {}");
	Xplicit::Lua::XLuaStateManager::get_singleton_ptr()->run_string("_G.Humanoid.Get = {}");

	lua_pushcfunction(Xplicit::Lua::XLuaStateManager::get_singleton_ptr()->state(), lua_GetHumanoidHealth);
	lua_setglobal(Xplicit::Lua::XLuaStateManager::get_singleton_ptr()->state(), "_G.Humanoid.Get.Health");

	lua_pushcfunction(Xplicit::Lua::XLuaStateManager::get_singleton_ptr()->state(), lua_SetHumanoidHealth);
	lua_setglobal(Xplicit::Lua::XLuaStateManager::get_singleton_ptr()->state(), "_G.Humanoid.Set.Health");
	...
	lua_setglobal(Xplicit::Lua::XLuaStateManager::get_singleton_ptr()->state(), "_G.Humanoid.Get.XplicitID");

	lua_pushcfunction(Xplicit::Lua::XLuaStateManager::get_singleton_ptr()->state(), lua_Kick);
	lua_setglobal(Xplicit::Lua::XLuaStateManager::get_singleton_ptr()->state(), "_G.Humanoid.Kick");
