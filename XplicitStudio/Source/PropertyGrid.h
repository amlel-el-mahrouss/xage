...
typedef struct tagPROPGRIDFDITEM {
    LPWSTR lpszDlgTitle; ///< Dialog title
    LPWSTR lpszFilePath; ///< Initial path
    LPWSTR lpszFilter;   ///< Double null terminated filter string
    LPWSTR lpszDefExt;   ///< Default extension
...
typedef struct tagPROPGRIDITEM {
    ...
    LPWSTR lpszzCmbItems; ///< Double null terminated list of strings
