...
namespace XPX
{
	...
	{
		mono_add_internal_call("XplicitNgine.Game::RegisterEvent", (const void*)&xplicit_register_event);
		mono_add_internal_call("XplicitNgine.Game::RegisterClass", (const void*)&xplicit_register_class);
	}
