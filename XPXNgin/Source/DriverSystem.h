...
namespace XPX::Renderer
{
	...
	enum class RENDER_TYPE
	{
		RENDER_MESH, // .xsd
		RENDER_TEXTURE, // .tga
		RENDER_POLYGON, // generated by renderer.
		RENDER_PARTICLE, // Fire, blood...
		RENDER_LIGHT, // light system
		RENDER_TYPE_COUNT,
	};
	...
	struct XPLICIT_API ImageDataParams final
	{
		...
		static ImageDataParams invald_image_data() { return ImageDataParams(); }
	...
	public:
		...
		const RENDER_TYPE render_type() noexcept { return RENDER_TYPE::RENDER_MESH; }
	...
	public:
		...
		const RENDER_TYPE render_type() noexcept { return RENDER_TYPE::RENDER_LIGHT; }
	...
	public:
		...
		float32 m_fPower{ 1.0 };
		float32 m_fWindPower{ 1.0 };
